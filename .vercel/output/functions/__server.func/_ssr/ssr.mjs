...
import { C as executeRewriteInput, D as isNotFound, E as rootRouteId, S as resolveManifestCssLink, T as isResolvedRedirect, a as replaceSsrResponse, b as getStylesheetHref, i as normalizeSsrResponse, k as invariant, l as RouterProvider, n as defineHandlerCallback, o as stripSsrResponseBody, r as isSsrResponse, t as renderRouterToStream, w as isRedirect, x as resolveManifestAssetLink, y as getScriptPreloadAttrs } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C6PY-C-Y.mjs");
